...
- Running default version of MONAN-Model (1.4.4) and convert_mpas (1.2.0).
...
- Desktop ubuntu 22.04 --> https://github.com/monanadmin/scripts_container/blob/develop/docs/desktop_ubuntu_22.04.txt
